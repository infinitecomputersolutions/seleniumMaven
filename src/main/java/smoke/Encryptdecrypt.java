...
public class Encryptdecrypt {
       ...
       public static String data ="RRY7dWHQlBn9VBQtg8oM9w==" ;
       // Responsible for setting, initializing this object's encrypter and
       Encryptdecrypt(String passPhrase) {
...
/*       public static void main(String[] args) {
              try {
                     ...
                     String encrypted = encrypter.encrypt("april@123");
                     System.out.println("encrypted String:" + encrypted);
                     String data ="EbQs29u+7LNhQEdLJ0N29Q==" ;
