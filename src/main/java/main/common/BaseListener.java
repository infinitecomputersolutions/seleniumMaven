...
public class BaseListener extends TestListenerAdapter implements IReporter {
	...
	protected PrintWriter createWriter(String outdir) throws IOException {
		...
		return new PrintWriter(new BufferedWriter(new FileWriter(new File(
				outdir, current+"\\Reports\\emailable-report.html"))));
	}
	...
	public class TestSorter implements Comparator<ITestNGMethod> {
		// ~ Methods
		// -------------------------------------------------------------
